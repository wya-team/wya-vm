    ...
    [
      ...
      _vm.active && _vm.handles && _vm.handles.length !== 0
        ? _c(
            "div",
            {
              class: { disabled: _vm.disabled, active: _vm.active },
              style: _vm.style
            },
            [
...
__vue_render__$3._withStripped = true;
  ...
  var __vue_inject_styles__$3 = function (inject) {
    if (!inject) { return }
    inject("data-v-456c5344_0", { source: ".vm-grid-lines[data-v-456c5344] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  overflow: hidden;\n  z-index: 0;\n}\n.vm-grid-lines .__x[data-v-456c5344] {\n    position: absolute;\n    left: 0;\n    width: 1px;\n    height: 100%;\n    border-left-width: 1px;\n    border-left-style: dotted;\n    border-left-color: #d6d6d6;\n    -webkit-box-sizing: border-box;\n            box-sizing: border-box;\n}\n.vm-grid-lines .__y[data-v-456c5344] {\n    position: absolute;\n    top: 0;\n    width: 100%;\n    height: 1px;\n    border-top-width: 1px;\n    border-top-style: dotted;\n    border-top-color: #d6d6d6;\n    -webkit-box-sizing: border-box;\n            box-sizing: border-box;\n}\n\n/*# sourceMappingURL=grid-lines.vue.map */", map: {"version":3,"sources":["/Users/deot/Desktop/wya/github/wya-vm/src/combo/frame/draggable/grid-lines.vue","grid-lines.vue"],"names":[],"mappings":"AA4DA;EACA,kBAAA;EACA,MAAA;EACA,OAAA;EACA,WAAA;EACA,YAAA;EACA,gBAAA;EACA,UAAA;AAAA;AAPA;IASA,kBAAA;IACA,OAAA;IACA,UAAA;IACA,YAAA;IACA,sBAAA;IACA,yBAAA;IACA,0BAAA;IACA,8BAAA;YAAA,sBAAA;AAAA;AAhBA;IAmBA,kBAAA;IACA,MAAA;IACA,WAAA;IACA,WAAA;IACA,qBAAA;IACA,wBAAA;IACA,yBAAA;IACA,8BAAA;YAAA,sBAAA;AAAA;;AC3DA,yCAAyC","file":"grid-lines.vue","sourcesContent":["<template>\n\t<div class=\"vm-grid-lines\">\n\t\t<div \n\t\t\tv-for=\"item in yArr\" \n\t\t\t:key=\"`y_${item}`\" \n\t\t\t:style=\"{top: `${item}px`}\"  \n\t\t\tclass=\"__y\"\n\t\t/>\n\t\t<div \n\t\t\tv-for=\"item in xArr\" \n\t\t\t:key=\"`x_${item}`\" \n\t\t\t:style=\"{left: `${item}px`}\"  \n\t\t\tclass=\"__x\"\n\t\t/>\n\t</div>\n</template>\n\n<script>\nexport default {\n\tname: 'vm-grid-lines',\n\tcomponents: {\n\n\t},\n\tprops: {\n\t\twidth: Number,\n\t\theight: Number,\n\t\tgrid: {\n\t\t\ttype: Array,\n\t\t\tdefault: () => {\n\t\t\t\treturn [10, 10];\n\t\t\t}\n\t\t},\n\t},\n\tdata() {\n\t\treturn {\n\t\t};\n\t},\n\tcomputed: {\n\t\txArr() {\n\t\t\tlet length = Math.floor(this.width / this.grid[0]);\n\t\t\treturn Array.from({ length }, (v, i) => i * this.grid[0]);\n\t\t},\n\t\tyArr() {\n\t\t\tlet length = Math.floor(this.height / this.grid[1]);\n\t\t\treturn Array.from({ length }, (v, i) => i * this.grid[1]);\n\t\t}\n\t},\n\twatch: {\n\t\t\n\t},\n\tcreated() {\n\t\t\n\t},\n\tmethods: {\n\n\t},\n};\n</script>\n\n<style lang=\"scss\" scoped>\n.vm-grid-lines {\n\tposition: absolute;\n\ttop: 0;\n\tleft: 0;\n\twidth: 100%;\n\theight: 100%;\n\toverflow: hidden;\n\tz-index: 0;\n\t.__x {\n\t\tposition: absolute;\n\t\tleft: 0;\n\t\twidth: 1px;\n\t\theight: 100%;\n\t\tborder-left-width: 1px;\n\t\tborder-left-style: dotted;\n\t\tborder-left-color: rgb(214, 214, 214);\n\t\tbox-sizing: border-box;\n\t}\n\t.__y {\n\t\tposition: absolute;\n\t\ttop: 0;\n\t\twidth: 100%;\n\t\theight: 1px;\n\t\tborder-top-width: 1px;\n\t\tborder-top-style: dotted;\n\t\tborder-top-color: rgb(214, 214, 214); \n\t\tbox-sizing: border-box;\n\t}\n}\n</style>\n",".vm-grid-lines {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  overflow: hidden;\n  z-index: 0; }\n  .vm-grid-lines .__x {\n    position: absolute;\n    left: 0;\n    width: 1px;\n    height: 100%;\n    border-left-width: 1px;\n    border-left-style: dotted;\n    border-left-color: #d6d6d6;\n    box-sizing: border-box; }\n  .vm-grid-lines .__y {\n    position: absolute;\n    top: 0;\n    width: 100%;\n    height: 1px;\n    border-top-width: 1px;\n    border-top-style: dotted;\n    border-top-color: #d6d6d6;\n    box-sizing: border-box; }\n\n/*# sourceMappingURL=grid-lines.vue.map */"]}, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$3 = "data-v-456c5344";
  /* module identifier */
...
var __vue_render__$6 = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.active
        ? _c("div", { class: { disabled: _vm.disabled, active: _vm.active } })
        : _vm._e()
    ]
  )
};
...
__vue_render__$6._withStripped = true;
  ...
  var __vue_inject_styles__$6 = function (inject) {
    if (!inject) { return }
    inject("data-v-287d5a2e_0", { source: ".vm-sort-list[data-v-287d5a2e] {\n  padding: 0;\n  -webkit-box-sizing: border-box;\n          box-sizing: border-box;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  position: relative;\n}\n.vm-sort-list[data-v-287d5a2e]:hover {\n    cursor: move;\n}\n.vm-sort-list .active[data-v-287d5a2e] {\n    padding: 0;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    position: absolute;\n    z-index: 2;\n    border: 1px dotted #108ee9;\n}\n\n/*# sourceMappingURL=sort-item.vue.map */", map: {"version":3,"sources":["/Users/deot/Desktop/wya/github/wya-vm/src/core/sort-item.vue","sort-item.vue"],"names":[],"mappings":"AAyGA;EACA,UAAA;EACA,8BAAA;UAAA,sBAAA;EACA,yBAAA;KAAA,sBAAA;MAAA,qBAAA;UAAA,iBAAA;EACA,kBAAA;AAAA;AAJA;IAMA,YAAA;AAAA;AANA;IASA,UAAA;IACA,MAAA;IACA,OAAA;IACA,QAAA;IACA,SAAA;IACA,kBAAA;IACA,UAAA;IACA,0BAAA;AAAA;;ACxGA,wCAAwC","file":"sort-item.vue","sourcesContent":["<template>\n\t<div class=\"vm-sort-list\" @mousedown.stop=\"handleContainerDown\">\n\t\t<div style=\"pointer-events: none;\">\n\t\t\t<slot />\n\t\t</div>\n\t\t<!-- handle -->\n\t\t<div v-if=\"active\" :class=\"{ disabled, active }\" />\n\t</div>\n</template>\n\n<script>\nimport { isPassiveSupported, eleInRegExp } from '../utils/helper';\nimport Draggable from './draggable.vue';\n\nconst doc = document.documentElement;\n\nexport default {\n\treplace: true,\n\tname: 'vm-srot-list',\n\tprops: {\n\t\tdisabled: Draggable.props.disabled,\n\t\teditorRegExp: Draggable.props.editorRegExp,\n\t\tprevent: Draggable.props.prevent,\n\t\tpreventRegExp: Draggable.props.preventRegExp,\n\t},\n\tdata() {\n\t\treturn {\n\t\t\tactive: false\n\t\t};\n\t},\n\tcomputed: {\n\t\t\n\t},\n\twatch: {},\n\tbeforeCreate() {\n\t\t// 组件捕获阶段执行\n\t\tthis.eventOpts = !isPassiveSupported || { capture: true, passive: true };\n\t},\n\tmounted() {\n\t\t\n\t},\n\tdestroyed() {\n\t\tthis.operateDOMEvents('remove');\n\t},\n\tmethods: {\n\t\toperateDOMEvents(type) {\n\t\t\tlet fn = type === 'add' ? doc.addEventListener : doc.removeEventListener;\n\n\t\t\tfn('mousedown', this.handleDeselect, this.eventOpts);\n\t\t},\n\t\t/**\n\t\t * 模拟设置active状态\n\t\t */\n\t\tsetActived() {\n\t\t\tthis.handleContainerDown();\n\t\t},\n\t\t/**\n\t\t * 组件被按下事件\n\t\t */\n\t\thandleContainerDown(e = {}) {\n\t\t\t// 去除默认事件 todo: 匹配输入框\n\t\t\tthis.prevent\n\t\t\t\t&& e.preventDefault \n\t\t\t\t&& !eleInRegExp(e.target, this.preventRegExp)\n\t\t\t\t&& e.preventDefault();\n\n\t\t\t// 判断是否支持拖动\n\t\t\tif (this.disabled) return;\n\t\t\tconst target = e.target || e.srcElement;\n\t\t\t// 确保事件发生在组件内部\n\t\t\tif (!target || this.$el.contains(target)) {\n\t\t\t\tif (!this.active) {\n\t\t\t\t\t// 绑定事件\n\t\t\t\t\tthis.operateDOMEvents('add');\n\n\t\t\t\t\tthis.active = true;\n\t\t\t\t\tthis.$emit('activated');\n\t\t\t\t}\n\t\t\t}\n\t\t},\n\t\t/**\n\t\t * 取消选择事件\n\t\t */\n\t\thandleDeselect(e) {\n\t\t\tconst target = e.target || e.srcElement; // body不要带上class, 否则会存在问题\n\n\t\t\tlet path = e.path || (e.composedPath && e.composedPath()) || [];\n\t\t\tif (\n\t\t\t\t!this.$el.contains(target) \n\t\t\t\t&& (!path.some(item => eleInRegExp(item, this.editorRegExp)))\n\t\t\t) {\n\t\t\t\tif (this.active) {\n\t\t\t\t\t// 解绑\n\t\t\t\t\tthis.operateDOMEvents('remove');\n\n\t\t\t\t\tthis.active = false;\n\t\t\t\t\tthis.$emit('deactivated');\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t},\n};\n</script>\n\n<style lang=\"scss\" scoped>\n.vm-sort-list {\n\tpadding: 0;\n\tbox-sizing: border-box;\n\tuser-select: none;\n\tposition: relative;\n\t&:hover {\n\t\tcursor: move;\n\t}\n\t.active {\n\t\tpadding: 0;\n\t\ttop: 0;\n\t\tleft: 0;\n\t\tright: 0;\n\t\tbottom: 0;\n\t\tposition: absolute;\n\t\tz-index: 2;\n\t\tborder: 1px dotted #108ee9;\n\t}\n}\n\n</style>\n",".vm-sort-list {\n  padding: 0;\n  box-sizing: border-box;\n  user-select: none;\n  position: relative; }\n  .vm-sort-list:hover {\n    cursor: move; }\n  .vm-sort-list .active {\n    padding: 0;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    position: absolute;\n    z-index: 2;\n    border: 1px dotted #108ee9; }\n\n/*# sourceMappingURL=sort-item.vue.map */"]}, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$6 = "data-v-287d5a2e";
  /* module identifier */
  ...
  var SortItem = normalizeComponent_1(
...
var script$7 = {
  ...
  methods: {
    ...
    handleDrop: function handleDrop(e) {
      ...
      if (!result) { return; } // let { x, y } = this.$el.getBoundingClientRect();
...
__vue_render__$7._withStripped = true;
  ...
  var __vue_inject_styles__$7 = function (inject) {
    if (!inject) { return }
    inject("data-v-6ef5b3ca_0", { source: "\n/*# sourceMappingURL=frame.vue.map */", map: {"version":3,"sources":["frame.vue"],"names":[],"mappings":";AACA,oCAAoC","file":"frame.vue"}, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__$7 = "data-v-6ef5b3ca";
  /* module identifier */
  ...
  var SortListFrame = normalizeComponent_1(
...
__vue_render__$a._withStripped = true;
  ...
  /* scoped */
  var __vue_scope_id__$a = "data-v-af214562";
  /* module identifier */
...
__vue_render__$c._withStripped = true;
  ...
  /* scoped */
  var __vue_scope_id__$c = "data-v-74d768f9";
  /* module identifier */
...
var root = (function () {
  ...
  try {
    ...
    var newFrame = cloneDeep(opts.Frame || (mode === 'draggable' ? DraggableFrame : SortListFrame));
